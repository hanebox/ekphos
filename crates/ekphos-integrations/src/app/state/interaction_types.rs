...
#[derive(Debug, Clone)]
pub enum LinkInfo {
    Markdown { text: String, url: String, start_col: usize, end_col: usize },
    Image { path: String, start_col: usize, end_col: usize },
    Wiki { target: String, heading: Option<String>, start_col: usize, end_col: usize, is_valid: bool },
}
